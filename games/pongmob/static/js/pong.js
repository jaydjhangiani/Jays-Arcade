...
class Pong {
    ...
    update(dt) {
        ...
        if (this.ball.left < 0 || this.ball.right > this.canvas.width) {
            ...
            if (this.players[1].score === 3) {
                ...
                document.getElementById("test").textContent =
                    "Played for " + min + " mins and " + sec + " seconds";
                scoretest = min * 60 + sec;
                fun();
            }
        ...
        this.players[1].pos.y = this.ball.pos.y * 0.95;
...
function fun() {
    ...
    const button1 = document.querySelector("#dummy");
